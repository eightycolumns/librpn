...
START_TEST(test_17) {
  test_for_malformed_expression_error("(a*(b+c)^d");
} END_TEST
...
START_TEST(test_23) {
  test_for_malformed_expression_error("a*()*d");
} END_TEST
...
TCase *malformed_infix_expression_tcase(void) {
  ...
  tcase_add_test(malformed_infix_expression_tcase, test_17);
  tcase_add_test(malformed_infix_expression_tcase, test_18);
  tcase_add_test(malformed_infix_expression_tcase, test_19);
  tcase_add_test(malformed_infix_expression_tcase, test_20);
  tcase_add_test(malformed_infix_expression_tcase, test_21);
  tcase_add_test(malformed_infix_expression_tcase, test_22);
  tcase_add_test(malformed_infix_expression_tcase, test_23);
  tcase_add_test(malformed_infix_expression_tcase, test_24);
